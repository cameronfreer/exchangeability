...
lemma block_coord_condIndep
  ...
  have finite_approx : ∀ (k : ℕ),
    ...
    intro k E hE
    -- This requires showing integrals match for cylinder sets
    -- Use contractability to show the joint distribution factorizes appropriately
    sorry -- TODO: Use contractable_finite_cylinder_measure and integral equality (2-3 hours)
