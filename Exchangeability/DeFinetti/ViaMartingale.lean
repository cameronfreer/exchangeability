...
lemma measurableSpace_pi_nat_le_iSup_fin {α : Type*} [MeasurableSpace α] :
  ...
  classical
  -- The Pi σ-algebra is generated by measurable cylinders.
  -- Every cylinder depends on finitely many coordinates, hence is in some comap.
  -- Therefore Pi ≤ ⨆ comaps.
  --
  -- This requires showing:
  -- 1. Each cylinder set is in the RHS (needs finite support analysis)
  -- 2. generateFrom cylinders ≤ RHS (follows from 1)
  --
  -- Without the finite support infrastructure, we leave this as sorry.
  sorry  -- TODO: Prove using generateFrom_measurableCylinders + finite support
