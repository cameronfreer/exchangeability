...
lemma directing_measure_measurable
  ...
  ·
    ...
    have h_induction : ∀ t (htm : MeasurableSet t), C t htm := by
      -- TODO: Fix MeasurableSpace.induction_on_inter API change
      -- The signature has changed in a recent mathlib version
      -- This is a standard Dynkin π-λ theorem argument
      sorry
