...
We have presented a Lean~4 formalization of de Finetti's theorem, including three independent proofs of the hard direction following Kallenberg's presentation. The formalization demonstrates that substantial probability theory can be developed in modern proof assistants, leveraging mathlib's measure-theoretic infrastructure.
