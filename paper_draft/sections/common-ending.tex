...
The key bridge lemma \texttt{complete\_from\_directing\_measure} in \texttt{CommonEnding.lean} takes a directing measure satisfying the cylinder-level product formula and produces the full \texttt{ConditionallyIID} conclusion by $\pi$-system extension.
