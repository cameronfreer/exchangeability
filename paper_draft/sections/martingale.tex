...
\item \textbf{Reverse martingale convergence}: For a decreasing sequence of $\sigma$-algebras $\cF_0 \supseteq \cF_1 \supseteq \cdots$, the conditional expectations $\E[f | \cF_n]$ converge a.e.\ and in $L^1$ to $\E[f | \cF_\infty]$, where $\cF_\infty = \bigcap_n \cF_n$.
\end{enumerate}
