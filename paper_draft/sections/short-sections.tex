...
Total lines of Lean code & $\sim$43,500 \\
Build jobs & 3,296 \\
Axioms used & 3 (standard) \\
\end{tabular}
\end{center}

\subsection{Artifact Accessibility}

The formalization is available at \url{https://github.com/cameronfreer/exchangeability} under an open-source license. Upon final publication, we will provide a Software Heritage persistent identifier (SWHID) for the code repository, as recommended by AFM guidelines.
