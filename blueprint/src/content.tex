...
would be wasteful if you already had per-coordinate CE equalities. At
the stitching level both routes compress to a short top-level theorem
that hands a 4-tuple
$(\nu, h_{\nu\text{-prob}}, h_{\nu\text{-meas}}, h_{\text{bridge}})$ to
the chosen ending — the choice of ending is what differs, not the
amount of stitching.
